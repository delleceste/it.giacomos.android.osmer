...
import it.giacomos.android.osmer.PROva.network.Data.DownloadListener;
import it.giacomos.android.osmer.PROva.network.state.BitmapType;
import it.giacomos.android.osmer.PROva.network.state.Offline;
import it.giacomos.android.osmer.PROva.network.state.Online;
import it.giacomos.android.osmer.PROva.network.state.State;
