...
import it.giacomos.android.osmer.PROva.MyAlertDialogFragment;
import it.giacomos.android.osmer.PROva.OsmerActivity;
import it.giacomos.android.osmer.PROva.R;
import it.giacomos.android.osmer.PROva.locationUtils.GeocodeAddressTask;
import it.giacomos.android.osmer.PROva.locationUtils.GeocodeAddressUpdateListener;
...
import it.giacomos.android.osmer.PROva.service.sharedData.ReportRequestNotification;
import it.giacomos.android.osmer.PROva.service.sharedData.ServiceSharedData;
import it.giacomos.android.osmer.PROva.widgets.map.MapBaloonInfoWindowAdapter;
import it.giacomos.android.osmer.PROva.widgets.map.OMapFragment;
import it.giacomos.android.osmer.PROva.widgets.map.OOverlayInterface;
import it.giacomos.android.osmer.PROva.widgets.map.OverlayType;
...
import it.giacomos.android.osmer.PROva.widgets.map.report.network.ReportUpdater;
import it.giacomos.android.osmer.PROva.widgets.map.report.network.ReportUpdaterListener;
