...
import it.giacomos.android.osmer.PROva.locationUtils.GeoCoordinates;
import it.giacomos.android.osmer.PROva.network.Data.DataPoolBitmapListener;
...
import it.giacomos.android.osmer.PROva.observations.ObservationDrawableIdPicker;
import it.giacomos.android.osmer.PROva.observations.ObservationType;
import it.giacomos.android.osmer.PROva.observations.ObservationsCacheUpdateListener;
import it.giacomos.android.osmer.PROva.preferences.Settings;
import it.giacomos.android.osmer.PROva.webcams.AdditionalWebcams;
import it.giacomos.android.osmer.PROva.webcams.ExternalImageViewerLauncher;
import it.giacomos.android.osmer.PROva.webcams.LastImageCache;
import it.giacomos.android.osmer.PROva.webcams.OtherWebcamListDecoder;
import it.giacomos.android.osmer.PROva.webcams.WebcamData;
import it.giacomos.android.osmer.PROva.widgets.OAnimatedTextView;
import it.giacomos.android.osmer.PROva.widgets.map.animation.RadarAnimation;
import it.giacomos.android.osmer.PROva.widgets.map.animation.RadarAnimationListener;
import it.giacomos.android.osmer.PROva.widgets.map.animation.RadarAnimationStatus;
import it.giacomos.android.osmer.PROva.widgets.map.report.ReportOverlay;
import it.giacomos.android.osmer.PROva.widgets.map.report.network.PostReportAsyncTaskPool;
