...
import it.giacomos.android.osmer.PROva.widgets.map.report.network.RemovePostTask;
import it.giacomos.android.osmer.PROva.widgets.map.report.network.RemovePostTaskListener;
...

{
	...
	/* OsmerActivity wants to be notified whether the task is completed (successfully or not)
	 ...
	 * task to be complete. OsmerActivity implements this interface.
	 * 
	 * @param parl (OsmerActivity)
	 */
	 ...
	 *  OsmerActivity implements PostActionResultListener.
	 */
